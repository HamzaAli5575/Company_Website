...
import { FaMicrophone, FaGlobe, FaCommentDots, FaPlug, FaTachometerAlt } from 'react-icons/fa'
...
const Page = () => {
  ...
  <>
   <header role="banner" className="relative w-full overflow-hidden min-h-[120px] md:h-[220px] lg:h-[280px] bg-black pt-16 md:pt-20">
    ...
    Our Smart Multilingual Translator service harnesses advanced AI to deliver seamless, real-time, and highly accurate translations across a diverse range of languages. Unlike traditional tools, it preserves context, tone, and technical jargon, ensuring that your communication remains precise and culturally appropriate, whether in documentation, live meetings, or dynamic content streams.
</p>
<p className="text-gray-300 text-base leading-relaxed text-justify opacity-0 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
    It integrates effortlessly into existing platforms and tools, providing instant translation for text, speech, and media. By utilizing sophisticated neural networks, we ensure high fidelity and speed, breaking down language barriers for global collaboration, content localization, and customer support. The result is crystal-clear cross-language communication that boosts international reach and operational efficiency.
</p>
            </div>
            <div className="flex justify-center">
              <div className="relative w-full max-w-md h-80 rounded-xl overflow-hidden border border-teal-500/30 shadow-2xl transform transition-all duration-700 hover:scale-105 hover:shadow-teal-500/25 hover:rotate-1 animate-fadeInUp">
                <Image
                 src="/images/Products-AI/SMLT.jpg"
                  alt="Smart Multilingual Translator"
                  fill
...
<div className="mb-16 opacity-0 transform translate-y-10 transition-all duration-1000 ease-out animate-on-scroll">
    <h2 className="text-2xl md:text-3xl font-bold text-white text-center mb-10 animate-fadeInUp">
        KEY <span className="text-teal-400">BENEFITS</span>
    </h2>
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
        ...
        <div className="group opacity-0 transform translate-y-6 animate-on-scroll transition-all duration-700 ease-out" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-teal-500/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-teal-500/20 group-hover:scale-110 transition-all duration-300 shrink-0">
                    {/* Placeholder Icon: FaLanguage or FaMicrophone */}
                    <FaMicrophone className="text-xl text-teal-400 group-hover:animate-pulse" /> 
                </div>
                <h4 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-300">Real-Time, Accurate Translation</h4>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed group-hover:text-white transition-colors duration-300">
                Instantly convert speech, text, and media with high fidelity, maintaining nuance and context across languages.
            </p>
        </div>
        ...
        <div className="group opacity-0 transform translate-y-6 animate-on-scroll transition-all duration-700 ease-out" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-teal-500/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-teal-500/20 group-hover:scale-110 transition-all duration-300 shrink-0">
                    {/* Placeholder Icon: FaGlobe or FaMapMarkerAlt */}
                    <FaGlobe className="text-xl text-teal-400 group-hover:animate-pulse" />
                </div>
                <h4 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-300">Global Market Expansion</h4>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed group-hover:text-white transition-colors duration-300">
                Break down communication barriers to reach new international customers and streamline global operations.
            </p>
        </div>
        ...
        <div className="group opacity-0 transform translate-y-6 animate-on-scroll transition-all duration-700 ease-out" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-teal-500/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-teal-500/20 group-hover:scale-110 transition-all duration-300 shrink-0">
                    {/* Placeholder Icon: FaBrain or FaCommentDots */}
                    <FaCommentDots className="text-xl text-teal-400 group-hover:animate-pulse" />
                </div>
                <h4 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-300">Context & Tone Preservation</h4>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed group-hover:text-white transition-colors duration-300">
                AI ensures that the original meaning, intent, and cultural nuances of the message are perfectly maintained.
            </p>
        </div>
        ...
        <div className="group opacity-0 transform translate-y-6 animate-on-scroll transition-all duration-700 ease-out" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-teal-500/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-teal-500/20 group-hover:scale-110 transition-all duration-300 shrink-0">
                    {/* Placeholder Icon: FaPlug or FaCodeBranch */}
                    <FaPlug className="text-xl text-teal-400 group-hover:animate-pulse" />
                </div>
                <h4 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-300">Seamless Platform Integration</h4>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed group-hover:text-white transition-colors duration-300">
                Easily embed the translator into your existing applications, websites, and communication tools.
            </p>
        </div>
        ...
        <div className="group opacity-0 transform translate-y-6 animate-on-scroll transition-all duration-700 ease-out" style={{ animationDelay: '0.5s' }}>
            <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-teal-500/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-teal-500/20 group-hover:scale-110 transition-all duration-300 shrink-0">
                    {/* Placeholder Icon: FaTachometerAlt or FaRocket */}
                    <FaTachometerAlt className="text-xl text-teal-400 group-hover:animate-pulse" />
                </div>
                <h4 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-300">Boosted Operational Efficiency</h4>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed group-hover:text-white transition-colors duration-300">
                Automate translation workflows, saving significant time and resources compared to manual processes.
            </p>
        </div>

...
import { FaShieldAlt, FaFileAlt, FaUsers, FaSearch, FaClipboardCheck, FaLock, FaChartLine, FaCertificate, FaGlobe, FaUserCheck, FaExclamationTriangle, FaCogs } from 'react-icons/fa'
        ...
        <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="observe-animate slide-left space-y-8 max-w-4xl mx-auto">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                  What is <span className="text-red-600">ISO 27701</span>?
                </h2>
              </div>

              <div className="space-y-6 text-gray-300 leading-relaxed">
                <p className="text-justify text-lg">
                  ISO 27701 is the international standard for Privacy Information Management Systems (PIMS). It serves as an extension to ISO 27001, providing a framework for organizations to establish, implement, maintain, and continually improve a Privacy Information Management System.
                </p>
                <p className="text-justify text-lg">
                  This standard helps organizations demonstrate compliance with privacy regulations such as GDPR, CCPA, and other data protection laws worldwide. By implementing ISO 27701, organizations can effectively manage personal data, protect individual privacy, and build trust with customers and stakeholders.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  icon: FaShieldAlt,
                  title: "PIMS Framework",
                  description: "Privacy management system structure"
                },
                {
                  icon: FaFileAlt,
                ...
                },
                {
                  ...
                  description: "Data subject and controller roles"
                },
                {
                  icon: FaSearch,
                  title: "Risk Assessment",
                  description: "Privacy risk evaluation"
                }
              ].map((item, i) => {
          ...
          <div className="mb-20">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Our ISO 27701 <span className="text-red-600">Services</span>
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  description: "Comprehensive evaluation of your current privacy management practices against ISO 27701 requirements to identify gaps and create a certification roadmap."
                },
                {
                  icon: FaFileAlt,
                  title: "Documentation",
                  description: "Complete PIMS documentation suite including privacy policies, data processing agreements, and records of processing activities."
                },
                {
                  icon: FaUsers,
                  title: "Training",
                  description: "Privacy awareness and compliance training covering data protection principles, GDPR requirements, and data subject rights handling."
                },
                {
                  icon: FaLock,
                  title: "Privacy Impact Assessment",
                  description: "Systematic assessment of privacy risks associated with data processing activities and implementation of appropriate protection measures."
                },
                {
                  icon: FaUserCheck,
                  title: "Data Subject Rights",
                  description: "Implementation of processes to handle data subject rights requests including access, rectification, erasure, and data portability."
                },
                {
                  icon: FaExclamationTriangle,
                  title: "Breach Management",
                  description: "Development of personal data breach notification procedures to meet regulatory requirements and minimize impact on data subjects."
                }
              ].map((item, i) => {
                const Icon = item.icon
                return (
              ...
              {[
                {
                  step: "1",
                  title: "Assessment",
                  description: "Evaluate current privacy posture and identify gaps against ISO 27701 requirements"
                },
                {
                  step: "2",
                  title: "Planning",
                  description: "Develop implementation roadmap and prioritize remediation activities"
                },
                {
                  step: "3",
                  title: "Implementation",
                  description: "Deploy privacy controls, documentation, and processes across the organization"
                },
                {
                  step: "4",
                  title: "Certification",
                  description: "Prepare for and support certification audit to achieve ISO 27701 compliance"
                }
              ].map((item, i) => (
          ...
          <div className="observe-animate">
            <div className="bg-gradient-to-r from-red-600/10 to-black border border-red-600/30 rounded-2xl p-12 md:p-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">Benefits of ISO <span className="text-red-600">27701</span> Certification</h2>
                ...
                {[
                  {
                    ...
                    description: "Robust protection of personal data and privacy rights"
                  },
                  {
                    icon: FaGlobe,
                    title: "Global Compliance",
                    description: "Meet GDPR, CCPA, and other international privacy regulations"
                  },
                  {
                    icon: FaChartLine,
                    title: "Competitive Advantage",
                    description: "Demonstrate commitment to privacy and build customer trust"
                  }
                ].map((item, i) => (
              ...
              <div className="mt-12 text-center">
                <p className="text-gray-300 text-lg italic">
                  Our ISO 27701 certification services help organizations achieve compliance with global privacy standards while building a strong foundation for trust and data protection.
                </p>
              </div>
            </div>
          </div>

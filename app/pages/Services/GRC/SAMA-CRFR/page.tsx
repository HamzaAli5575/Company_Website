...
const Page = () => {
  ...
  // Key Components for SAMA CRFR
  const keyComponents = [
    { icon: FaShieldAlt, title: "Cyber Resilience Framework", desc: "Comprehensive controls and requirements for cyber resilience and recovery." },
    { icon: FaNetworkWired, title: "Network Resilience", desc: "Protection and recovery of infrastructure and network segmentation." },
    { icon: FaUserShield, title: "Access Management", desc: "Identity and access controls for critical systems and data." },
    { icon: FaExclamationTriangle, title: "Incident Response", desc: "Preparedness and rapid response to incidents and disruptions." },
    { icon: FaFileAlt, title: "Documentation & Reporting", desc: "Documentation and reporting to meet audit and resilience requirements." },
    { icon: FaSync, title: "Continuous Monitoring", desc: "Ongoing monitoring, resilience testing, and compliance tracking." },
    { icon: FaBalanceScale, title: "Risk Management", desc: "Risk assessment and mitigation strategies for resilience." },
    { icon: FaBuilding, title: "Governance", desc: "Cyber resilience governance and organizational roles." }
  ]

  // Assessment Areas
  const assessmentAreas = [
    { icon: FaClipboardCheck, title: "Gap Analysis", desc: "Identify gaps between current resilience posture and framework requirements." },
    { icon: FaSearch, title: "Control Evaluation", desc: "Assessment of technical and organizational resilience controls." },
    { icon: FaGavel, title: "Policy Review", desc: "Review and enhancement of resilience and recovery policies." },
    { icon: FaChartBar, title: "Maturity Scoring", desc: "Scoring and benchmarking of resilience maturity levels." }
  ]
  ...
  const complianceServices = [
    {
      icon: FaSearch,
      title: "CRFR Gap Assessment",
      description: "Evaluation of cyber resilience controls and processes against framework requirements.",
      features: [
        "Gap analysis",
    ...
    },
    {
      ...
      description: "Development and enhancement of resilience and recovery policies, procedures, and documentation.",
      features: [
        "Policy drafting & review",
        "Procedure development",
        "Incident response plans",
        "Recovery testing materials",
        "Audit documentation",
    ...
    },
    {
      ...
      description: "Implementation of technical and organizational controls for resilience and recovery.",
      features: [
    ...
    {
      icon: FaSync,
      title: "Continuous Resilience Monitoring",
      description: "Ongoing monitoring, periodic reviews, and support to maintain resilience compliance.",
      features: [
  ...
  // SAMA CRFR Requirements
  const samaRequirements = [
    {
      title: "Governance & Organization",
      description: "Establishing cyber resilience governance, roles, and responsibilities.",
      items: [
    ...
    },
    {
      ...
      description: "Identification, assessment, and mitigation of resilience risks.",
      items: [
    ...
    },
    {
      ...
      description: "Implementation of technical and operational controls for resilience and recovery.",
      items: [
  ...
  const keyRegulations = [
    { title: "Cyber Resilience Framework", description: "Comprehensive requirements for cyber resilience and recovery." },
    { title: "CRFR Assessment", description: "Self-assessment and validation of resilience maturity." },
    { title: "Circulars & Guidelines", description: "Ongoing regulatory updates and clarifications." },
    { title: "ISO/IEC 22301", description: "International standard for business continuity management systems." }
  ]
      ...
      <header role="banner" className="relative w-full h-[400px] md:h-[500px] overflow-hidden bg-black flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-4 space-y-6">
          <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto" style={{ letterSpacing: '-0.02em' }}>
            SAMA <span className="text-red-600">CRFR Assessment</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed text-justify">
            Guidance and support for Cyber Resilience Framework compliance and assessment.
          </p>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4 relative z-10">
              ...
              <div className="observe-animate slide-left space-y-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-red-600 font-semibold uppercase text-sm tracking-wider">Cyber Resilience Framework</span>
                  </div>
                  <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                    CRFR Assessment & Compliance
                  </h2>
                </div>
                <p className="text-gray-400 text-lg leading-relaxed text-justify">
                  The Cyber Resilience Framework requires regulated entities to implement robust controls and perform regular assessments. These assessments ensure organizations have effective resilience, recovery, and are prepared for disruptions.
                </p>
                <p className="text-gray-400 text-lg leading-relaxed text-justify">
                  Our CRFR Assessment services help organizations identify compliance gaps, strengthen resilience posture, and achieve regulatory assurance. We guide you through the process, from gap analysis to remediation and reporting.
                </p>
              ...
              <div className="observe-animate slide-right">
                <div className="relative h-96 md:h-full rounded-2xl overflow-hidden border-2 border-red-600/30 shadow-2xl group">
                  <Image
                    ...
                    alt="SAMA CRFR Cyber Resilience"
                    fill
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                CRFR <span className="text-red-600">Key Components</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                CRFR <span className="text-red-600">Assessment Focus</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                CRFR <span className="text-red-600">Requirements</span>
              </h2>
            </div>
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Our CRFR <span className="text-red-600">Services</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="mb-32 observe-animate">
            <div className="bg-gradient-to-r from-red-600/10 to-black border border-red-600/30 rounded-2xl p-12 md:p-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">
                Benefits of <span className="text-red-600">Resilience Compliance</span>
              </h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32 observe-animate">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Who Needs <span className="text-red-600">CRFR Compliance?</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32 observe-animate">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Our <span className="text-red-600">CRFR Compliance Approach</span>
              </h2>
            </div>
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-2xl p-10 hover:border-red-600/50 transition-all">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-white">Resilience Expertise</h3>
                </div>
                <div className="space-y-4">
                  <p className="text-gray-300 text-justify">Cyber Resilience Specialists</p>
                  ...
                  <p className="text-gray-300 text-justify">Continuous Resilience Monitoring</p>
                </div>
              </div>
              <div className="bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-2xl p-10 hover:border-red-600/50 transition-all">
                <div className="flex items-center gap-3 mb-8">
          ...
          <div className="observe-animate">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                CRFR <span className="text-red-600">Implementation Details</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 rounded-xl border border-white/10 hover:border-red-600/50 transition-all group">
                ...
                <p className="text-gray-300 text-justify">
                  CRFR assessment is mandatory for all regulated entities. Non-compliance can result in penalties and reputational risk.
                </p>
              </div>
              <div className="p-8 rounded-xl border border-white/10 hover:border-red-600/50 transition-all group">
              ...
              <div className="p-8 rounded-xl border border-white/10 hover:border-red-600/50 transition-all group">
                ...
                <p className="text-gray-300 text-justify">
                  Achieving compliance strengthens resilience against disruptions and enhances trust with stakeholders.
                </p>
              </div>
            </div>
          </div>

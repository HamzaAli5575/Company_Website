...
const Page = () => {
  ...
  // Key Components for SAMA MVC
  const keyComponents = [
    { icon: FaShieldAlt, title: "SAMA Cybersecurity Framework", desc: "Alignment with SAMA's comprehensive cybersecurity controls and requirements for financial institutions." },
    { icon: FaNetworkWired, title: "Network Security", desc: "Protection of critical infrastructure and secure network segmentation." },
    { icon: FaUserShield, title: "Access Management", desc: "Robust identity and access controls for sensitive systems and data." },
    { icon: FaExclamationTriangle, title: "Incident Response", desc: "Preparedness and rapid response to cybersecurity incidents and breaches." },
    { icon: FaFileAlt, title: "Documentation & Reporting", desc: "Comprehensive documentation and reporting to meet SAMA audit requirements." },
    { icon: FaSync, title: "Continuous Monitoring", desc: "Ongoing monitoring, vulnerability management, and compliance tracking." },
    { icon: FaBalanceScale, title: "Risk Management", desc: "Systematic risk assessment and mitigation strategies." },
    { icon: FaBuilding, title: "Governance", desc: "Establishing cybersecurity governance and organizational roles." }
  ]

  // SAMA MVC Assessment Areas
  const assessmentAreas = [
    { icon: FaClipboardCheck, title: "Gap Analysis", desc: "Identify gaps between current cybersecurity posture and SAMA requirements." },
    { icon: FaSearch, title: "Control Evaluation", desc: "Assessment of technical and organizational controls against SAMA standards." },
  ...
  const complianceServices = [
    {
      icon: FaSearch,
      title: "SAMA MVC Gap Assessment",
      description: "Comprehensive evaluation of your organization's cybersecurity controls and processes against SAMA's requirements.",
      features: [
    ...
    },
    {
      ...
      description: "Development and enhancement of cybersecurity policies, procedures, and documentation to meet SAMA standards.",
      features: [
    ...
    },
    {
      ...
      description: "Implementation of technical and organizational controls required by SAMA, tailored to your environment.",
      features: [
    ...
    },
    {
      ...
      description: "Ongoing monitoring, periodic reviews, and support to maintain SAMA compliance.",
      features: [
        ...
        "Annual SAMA review support"
      ]
    }
  ]

  // SAMA MVC Requirements
  const samaRequirements = [
    {
      title: "Governance & Organization",
      description: "Establishing cybersecurity governance, roles, and responsibilities as per SAMA MVC.",
      items: [
    ...
    },
    {
      ...
      description: "Systematic identification, assessment, and mitigation of cybersecurity risks.",
      items: [
    ...
    },
    {
      ...
      description: "Ensuring ongoing compliance and timely reporting to SAMA.",
      items: [
  ...
  // Key SAMA Regulations
  const keyRegulations = [
    { title: "SAMA Cybersecurity Framework", description: "Comprehensive cybersecurity requirements for Saudi financial sector." },
    { title: "SAMA MVC Assessment", description: "Mandatory self-assessment and external validation of cybersecurity maturity." },
    { title: "SAMA Circulars & Guidelines", description: "Ongoing regulatory updates and clarifications from SAMA." },
      ...
      <header role="banner" className="relative w-full h-[400px] md:h-[500px] overflow-hidden bg-black flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-4 space-y-6">
          <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto" style={{ letterSpacing: '-0.02em' }}>
            SAMA <span className="text-red-600">MVC Assessment</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed text-justify">
            Expert guidance and support for SAMA Cybersecurity Framework compliance and MVC assessment in financial sector.
          </p>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4 relative z-10">
              ...
              <div className="observe-animate slide-left space-y-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-red-600 font-semibold uppercase text-sm tracking-wider">Financial Sector Cybersecurity</span>
                  </div>
                  <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                    SAMA MVC Assessment & Compliance
                  </h2>
                </div>
                <p className="text-gray-400 text-lg leading-relaxed text-justify">
                  The Saudi Arabian Monetary Authority (SAMA) requires all regulated entities to comply with its Cybersecurity Framework and perform regular Maturity and Validation Cycle (MVC) assessments. These assessments ensure organizations have robust cybersecurity controls, effective risk management, and are prepared for evolving threats.
                </p>
                <p className="text-gray-400 text-lg leading-relaxed text-justify">
                  Our SAMA MVC Assessment services help financial institutions identify compliance gaps, strengthen their security posture, and achieve regulatory assurance. We guide you through the entire process, from gap analysis to remediation and reporting.
                </p>
                <div className="pt-6 space-y-3">
                  {['Gap Analysis', 'Control Evaluation', 'Policy Review', 'Maturity Scoring', 'Remediation Planning', 'SAMA Reporting'].map((item, i) => (
          ...
          <div className="mb-32 observe-animate">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Key SAMA <span className="text-red-600">Regulations & Standards</span>
              </h2>
            </div>
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                SAMA MVC <span className="text-red-600">Key Components</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                SAMA MVC <span className="text-red-600">Assessment Focus</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                SAMA <span className="text-red-600">Requirements</span>
              </h2>
            </div>
          ...
          <div className="mb-32">
            <div className="text-center mb-16 observe-animate">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Our SAMA MVC <span className="text-red-600">Services</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="mb-32 observe-animate">
            <div className="bg-gradient-to-r from-red-600/10 to-black border border-red-600/30 rounded-2xl p-12 md:p-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">
                Benefits of SAMA <span className="text-red-600">Compliance</span>
              </h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32 observe-animate">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Who Needs <span className="text-red-600">SAMA Compliance?</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="mb-32 observe-animate">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Our <span className="text-red-600">SAMA Compliance Approach</span>
              </h2>
            </div>
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-2xl p-10 hover:border-red-600/50 transition-all">
                ...
                <div className="space-y-4">
                  <p className="text-gray-300 text-justify">SAMA Cybersecurity Specialists</p>
                  <p className="text-gray-300 text-justify">Financial Sector Experience</p>
              ...
              <div className="bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-2xl p-10 hover:border-red-600/50 transition-all">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300 text-justify">SAMA Liaison & Communication</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="observe-animate">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                SAMA MVC <span className="text-red-600">Implementation Details</span>
              </h2>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 rounded-xl border border-white/10 hover:border-red-600/50 transition-all group">
                ...
                <p className="text-gray-300 text-justify">
                  SAMA MVC assessment is mandatory for all regulated entities. Non-compliance can result in regulatory penalties and reputational risk.
                </p>
              </div>
              <div className="p-8 rounded-xl border border-white/10 hover:border-red-600/50 transition-all group">
              ...
              <div className="p-8 rounded-xl border border-white/10 hover:border-red-600/50 transition-all group">
                ...
                <p className="text-gray-300 text-justify">
                  Achieving SAMA compliance strengthens your organizations resilience against cyber threats and enhances trust with regulators and customers.
                </p>
              </div>
            </div>
          </div>
